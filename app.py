...
if opcao == "1. IA das Notas Escolares":
    with st.container(key="bloco_notas"):
        ...
        horas_input = st.slider("Selecione a quantidade de Horas de Estudo:", 0, 12, 6, key="sld_1")
...
# -------------------------------------------------------------
    ...
    with st.container(key="bloco_gamer"):
        ...
        horas_input = st.slider("Horas Jogando continuamente:", 0, 15, 5, key="sld_2")
...
# -------------------------------------------------------------
    ...
    with st.container(key="bloco_sorvete"):
        ...
        temp_input = st.slider("Temperatura Externa (°C):", 15, 42, 28, key="sld_3")
...
# -------------------------------------------------------------
    ...
    with st.container(key="bloco_ninja"):
        ...
        faltas_input = st.number_input("Insira o total de Faltas do Aluno:", min_value=0, max_value=20, value=3, key="num_4")
...
# -------------------------------------------------------------
    ...
    with st.container(key="bloco_pet"):
        ...
        passeios_input = st.slider("Total de passeios efetuados:", 0, 7, 3, key="sld_5")
...
# -------------------------------------------------------------
    ...
    with st.container(key="bloco_filme"):
        ...
        duracao_input = st.slider("Tempo de Duração do Filme (Minutos):", 60, 180, 105, key="sld_6")
...
# -------------------------------------------------------------
    ...
    with st.container(key="bloco_pizza"):
        ...
        tamanho_input = st.slider("Escolha o tamanho da Pizza (Diâmetro em cm):", 15, 50, 32, key="sld_7")
...
# -------------------------------------------------------------
    ...
    with st.container(key="bloco_musica"):
        ...
        bpm_input = st.slider("Batidas Por Minuto (BPM) da Faixa:", 60, 200, 115, key="sld_8")
...
# -------------------------------------------------------------
    ...
    with st.container(key="bloco_cafe"):
        ...
        xicaras_input = st.slider("Total de Xícaras Ingeridas:", 0, 8, 3, key="sld_9")
...
# -------------------------------------------------------------
    ...
    with st.container(key="bloco_heroi"):
        ...
        forca_input = st.slider("Defina o Nível de Força do Herói (1 a 10):", 1, 10, 5, key="sld_10")
